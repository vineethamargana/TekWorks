...
public class Hotel_Controller {
	...
	public ResponseEntity<Hotel_Model> updateHotel(@PathVariable Long hid,@RequestBody Hotel_Model hotel_Model)
	{
	   
	   return new ResponseEntity<>(hotel_Service.updateHotel(hid,hotel_Model),HttpStatus.OK);
	}
